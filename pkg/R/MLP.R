...
#' @param x is the input table of gene-sets and gene-names. (geneSet from annotation package BioC)
#' @param y is the input table of gene-names and gene-statistics. (genePValue from data file experiment [e.g. generated by limma])
#' @param y2x is the mapping of the gene-names in y to those in x. (mappingFunctionOutput)
